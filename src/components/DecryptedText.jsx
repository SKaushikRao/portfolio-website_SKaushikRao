 ...
 * - animateOn?: "view" | "hover" | "manual"  (default: "hover")
 * - isManuallyTriggered?: boolean  (for "manual" mode)
 */
export default function DecryptedText({
  ...
  useEffect(() => {
    if (animateOn === 'manual' && isManuallyTriggered && !hasAnimated) {
      setIsManualActive(true);
      setHasAnimated(true);
    }
  }, [animateOn, isManuallyTriggered, hasAnimated]);
  ...
  useEffect(() => {
    ...
    const shouldAnimate = 
      ...
      (animateOn === 'manual' && isManualActive) ||
  ...
  // Determine if text should appear as revealed or encrypted
  const isAnimating = (animateOn === 'hover' && isHovering) || 
                      (animateOn === 'manual' && isManualActive) || 
                      (animateOn === 'view' && hasAnimated);
